...
@Component({
  selector: 'app-show-prg-questions',
  templateUrl: './show-prg-questions.component.html',
  styleUrls: ['./show-prg-questions.component.css']
})
export class ShowPrgQuestionsComponent implements OnInit 
{
